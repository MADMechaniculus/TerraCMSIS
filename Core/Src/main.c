...
int main(void)
{
  ...
  //HAL_GPIO_WritePin(TPA_Shutdown_GPIO_Port, TPA_Shutdown_Pin, GPIO_PIN_RESET);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LCD_RS_Pin|LCD_RW_Pin|LCD_D7_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LCD_RS_Pin|LCD_RW_Pin|LCD_D7_Pin;
